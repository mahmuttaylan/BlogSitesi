...
namespace BlogProject.Web.Areas.Admin.ViewComponents
{
    public class DashboardHeaderViewComponent : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()    //Index'e karşılık gelen => InvokeAsync
        {
            ...
            //Role mapping işleminde eşleştirilmediği için onu manuel olarak bulup atamasını yaparız. GetRolesAsync metodu parametre olarak AppUser istediği için map'lenmeden önceki hali yazılır.
