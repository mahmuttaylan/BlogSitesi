        ...
        public async Task<bool> UserProfileUpdate(UserProfileVM userProfileVM) 
        {
            ...
            if (isVerified && userProfileVM.NewPassword != null)    //user doğrulanmış ve şifre değiştiriyorsa***
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //yeni şifresi ile giriş yapıldı. bu kodlarla gir-çık olayı otomatik yapılır. istersek login sayfasına yönlendirip kendisine de yaptırabiliriz bu işlemleri
